    ...
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="card">
        <div className="border-b border-slate-200 px-6 py-4">
          <h3 className="text-base font-semibold text-slate-800">Mis respuestas rápidas</h3>
          <p className="text-sm text-slate-500">Plantillas personales para insertar en el comentario del ticket.</p>
        </div>
